  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        <Card><CardContent className="p-4"><p className="text-xs text-text-dim font-semibold uppercase">Réservées</p><p className="text-2xl font-bold text-amber-400">{nbReserve}</p></CardContent></Card>
                  ...
                  <tr key={b.n_bv} className="hover:bg-surface-hover transition-colors">
                    ...
                    <td className="px-4 py-3 text-center">
                      {b.archiver ? (
                        ...
                        <Badge className="bg-[rgba(251,191,36,0.10)] text-amber-400 border border-[rgba(251,191,36,0.20)] hover:bg-[rgba(251,191,36,0.15)]">Réservée</Badge>
                      )}
                    </td>
                  </tr>
                ))}
